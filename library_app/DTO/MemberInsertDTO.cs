...
namespace library_app.DTO
{
    ...
    {
        [Required(ErrorMessage = "You must provide a firstname"), MaxLength(50, ErrorMessage = "The first name must not exceed 50 characters"),
       RegularExpression(@"^\p{L}+$", ErrorMessage = "The first name must not contain numbers or symbols"),
           NotNull]
        public string? Firstname { get; set; }

        [Required(ErrorMessage = "You must provide a firstname"),MaxLength(50, ErrorMessage = "The last name must not exceed 50 characters"),
